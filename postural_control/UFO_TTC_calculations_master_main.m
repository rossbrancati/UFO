...
for subject = 1:3
    ...
    for trial = 1:8
        ...
        if trial == 1
            ...
            [mean_ttc, med_ttc, min_ttc] = ttc_bound_8(bound_ttc, 50, 0, bound_labels);
            ...
            %Compute TtC to each boundary
            %Make sure the number of boundary labels (N) is correct in the function ttc_bound_N
            [mean_ttc, med_ttc, min_ttc] = ttc_bound_6(bound_ttc, 50, 0, bound_labels);
            ...
            %Compute TtC to each boundary
            %Make sure the number of boundary labels (N) is correct in the function ttc_bound_N
            [mean_ttc, med_ttc, min_ttc] = ttc_bound_4(bound_ttc, 50, 0, bound_labels);
    ...
    ttc_final = (ttc_master + ttc_master)/subject;
