...
if show
   ...
   set(gca,'box','on')
   hold on
   plot(x,y,'Color', [.5333, .1098, .1098]) 
   plot(x(1),y(1),'vg',x(end),y(end),'vb')
   %axis([-150 150 -150 150])
   %plot(ellip(:,1),ellip(:,2),'k','linewidth',2)
   %plot([ax(1,:); 2*m(1,:)-ax(1,:)],[ax(2,:); 2*m(2,:)-ax(2,:)],'k--', 'linewidth',2)
