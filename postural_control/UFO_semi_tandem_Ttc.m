...
filepath = ['/Users/rossbrancati/Desktop/post_control_data/P86/UFO_p86_SPPB_0002.mat'];
load(filepath);

mat_file = UFO_p86_SPPB_0003;
...
%marker locations
%r1stmet = [mean(mat_file.Trajectories.Labeled.Data(3,2,:)), mean(mat_file.Trajectories.Labeled.Data(3,1,:))];
r2ndmet = [mean(mat_file.Trajectories.Labeled.Data(4,2,:)), mean(mat_file.Trajectories.Labeled.Data(4,1,:)+60)];
r5thmet = [mean(mat_file.Trajectories.Labeled.Data(5,2,:)), mean(mat_file.Trajectories.Labeled.Data(5,1,:))];
rlatheel = [mean(mat_file.Trajectories.Labeled.Data(4,2,:)), mean(mat_file.Trajectories.Labeled.Data(4,1,:))];
rheel = [mean(mat_file.Trajectories.Labeled.Data(6,2,:)), mean(mat_file.Trajectories.Labeled.Data(6,1,:))];
lheel = [mean(mat_file.Trajectories.Labeled.Data(7,2,:)), mean(mat_file.Trajectories.Labeled.Data(7,1,:))];
llatheel = [mean(mat_file.Trajectories.Labeled.Data(15,2,:)), mean(mat_file.Trajectories.Labeled.Data(15,1,:))];
%l1stmet = [mean(mat_file.Trajectories.Labeled.Data(11,2,:)), mean(mat_file.Trajectories.Labeled.Data(11,1,:))];
l2ndmet = [mean(mat_file.Trajectories.Labeled.Data(12,2,:)), mean(mat_file.Trajectories.Labeled.Data(12,1,:))+60];
l5thmet = [mean(mat_file.Trajectories.Labeled.Data(13,2,:)), mean(mat_file.Trajectories.Labeled.Data(13,1,:))];

%Left Leg forward bound_pts%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%8 Markers
%bound_pts = [rtoe; r5thmet; rlatheel; rheel; lheel; llatheel; l5thmet; ltoe];
%6 markers
bound_pts = [l2ndmet; r2ndmet; r5thmet; rheel; llatheel; l5thmet];

%Right Leg forward bound_pts%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%8 Markers
%bound_pts = ;
%6 Markers
%bound_pts = [r2ndmet; r5thmet; rlatheel; lheel; l5thmet; l2ndmet];
%4 markers
%bound_pts = [r1stmet; r5thmet; lheel; l5thmet];
...
[ mean_ttc, med_ttc, min_ttc ] = ttc_bound_5( bound_ttc, 50, method, bound_labels );