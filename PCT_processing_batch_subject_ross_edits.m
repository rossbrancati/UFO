...
for i = 1:length(file_list)
    ...
    %  16) added in apm_peak and adm_peak
     y = {age_sex studyid runcode ogspeed mass height speed sl sl_hgt cadence grf1 grf2... 
      ...
      asrom_gc aev_peak pant_peak pdrop_peak prot_peak first_kem_peak kfm_peak...
     ...
     file = '/Users/rossbrancati/Box/UFO/Gait_Processed_Master/UFO_Gait_Discrete_Variables.xlsx';
    ...
    y_total = y_total + cell2mat(y(1,5:74));
...
y_mean_cell_labs = {age_sex studyid runcode ogspeed};
